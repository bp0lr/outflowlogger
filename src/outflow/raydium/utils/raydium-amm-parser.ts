...
const SwapBaseInLayout = struct<SwapBaseIn>([u8("logType"), u64("amountIn"), u64("minimumOut"), u64("direction"), u64("userSource"), u64("poolCoin"), u64("poolPc"), u64("outAmount")]);
...
const SwapBaseOutLayout = struct<SwapBaseOut>([u8("logType"), u64("maxIn"), u64("amountOut"), u64("direction"), u64("userSource"), u64("poolCoin"), publicKey("poolCoinTokenAccount"), u64("poolPc"), u64("directIn")]);

type RaydiumInitializeArgs = {
  nonce: number;
  openTime: bigint;
};
const RaydiumInitializeArgsLayout = struct<RaydiumInitializeArgs>([u8("nonce"), u64("openTime")]);

type RaydiumInitialize2Args = RaydiumInitializeArgs & {
  initPcAmount: bigint;
  initCoinAmount: bigint;
};
const RaydiumInitialize2ArgsLayout = struct<RaydiumInitialize2Args>([u8("nonce"), u64("openTime"), u64("initPcAmount"), u64("initCoinAmount")]);
